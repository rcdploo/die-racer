...
#word lists (hardcoded - no API dependency)
_adjectives = [
  "ablaze","absurd","ancient","angry","arctic","atomic","awful","blazing","blind","bloody",
  "bold","brazen","broken","bronze","brutal","burning","chaotic","chrome","classic","clever",
  "clockwork","cloudy","colossal","cosmic","crimson","crooked","cruel","cursed","dazzling","dead",
  "deadly","deranged","devious","dirty","divine","dizzy","double","dreadful","drifting","driven",
  "dusty","electric","endless","epic","eternal","evil","exploding","fabled","feral","fierce",
  "fiery","filthy","flaming","flying","forgotten","frantic","frozen","furious","ghastly","ghost",
  "gilded","glorious","glowing","gnarly","golden","grim","gritty","grizzled","groaning","growling",
  "guilty","gushing","haunted","hollow","holy","howling","hungry","icy","immortal","infamous",
  "infernal","insane","invincible","iron","jagged","jaded","jolting","jumbled","killer","kinetic",
  "knuckle","legendary","lethal","livid","loaded","loco","lone","loud","lunatic","lurking",
  "mad","mangled","massive","mean","melting","menacing","merciless","mighty","molten","monstrous",
  "mortal","muddy","mysterious","neon","notorious","nuclear","oblique","obscure","obsidian","odd",
  "outlaw","overloaded","phantom","polished","primal","prime","psychic","raging","rampant","rapid",
  "ravenous","reckless","relentless","renegade","restless","rogue","rough","rugged","ruined","rusty",
  "savage","scarred","scorched","scrawny","shadow","shattered","silver","sinister","skeletal","sly",
  "smoking","sonic","spectral","speedy","spiky","spinning","stealth","stellar","stone","stormy",
  "strange","stray","sullen","supercharged","surging","swift","tattered","tenacious","terrifying","thunder",
  "toxic","twisted","unhinged","unruly","unstoppable","vicious","vigilant","violent","viral","volatile",
  "wandering","warped","wicked","wild","withered","wolfish","wretched","writhing","zapping","zealous"
]

_nouns = [
  "anvil","arrow","axle","bandit","beast","behemoth","blade","blaze","bolt","boulder",
  "brute","bullet","cannon","claw","comet","crater","cyclone","dagger","demon","devil",
  "diesel","drifter","dynamo","eagle","ember","engine","fang","fist","flame","flash",
  "forge","frenzy","fury","ghost","giant","glacier","gladiator","goblin","gorilla","grinder",
  "hammer","havoc","hawk","hazard","hellion","hornet","howler","hulk","hunter","hydra",
  "impact","inferno","iron","jackal","jaguar","juggernaut","kraken","lance","lancer","legend",
  "leopard","lightning","lion","lizard","locomotive","lurker","lynx","mace","mammoth","maniac",
  "marauder","maverick","meteor","minotaur","missile","mongoose","monster","mustang","nightmare","ogre",
  "outlaw","panther","phantom","phoenix","piston","plague","predator","python","rampage","raptor",
  "raider","rattler","ravager","reaper","renegade","rhino","ripper","rocket","ronin","rover",
  "rumble","saboteur","scorpion","serpent","shadow","shark","shockwave","sledge","slayer","smasher",
  "socket","specter","spike","stallion","stampede","storm","striker","supernova","surge","tank",
  "tempest","terror","tiger","titan","tornado","torpedo","troll","tundra","turbo","tyrant",
  "undertaker","venom","viper","volcano","vortex","vulture","warden","warlock","warlord","wasp",
  "watcher","wedge","werewolf","whiplash","whirlwind","wildcat","wolverine","wraith","wrecker","zealot"
]

random.shuffle(_adjectives)
random.shuffle(_nouns)
adjectives = [{'word': w} for w in _adjectives]
nouns = [{'word': w} for w in _nouns]
